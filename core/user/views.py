...
# Edicion de perfil por usuario logueado
...
class UserChangePasswordView(LoginRequiredMixin, FormView):
    ...
    def get_form(self, form_class=None):
        ...
        form.fields['new_password1'].help_text = 'Debe ser alfanumerica, mínimo de 8 caracteres, no parecerse a su información personal, ni a otra contraseña utilizada'
